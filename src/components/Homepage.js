  ...
  return (
    <div style={styles.container}>
      ...
      <section style={styles.cta} id="pesan">
        ...
        <p style={{ marginBottom: 30 }}>Klik tombol emot 💬 untuk pesan atau consultasi lewat WhatsApp</p>
  ...
  <div style={styles.testimonialContainer}>
    <div style={styles.testimonialCard}>
      <p style={styles.testimonialText}>
        “Pelayanan super cepat dan hasilnya memuaskan banget. Nggak nyangka bisa selesai dalam sehari! Mantap GaspollJokk!”
      </p>
      <p style={styles.testimonialAuthor}>— Rina, Mahasiswi Teknik</p>
    </div>
    <div style={styles.testimonialCard}>
      <p style={styles.testimonialText}>
        “Codingan gue error mulu, tapi tim Gaspoll langsung bantu dan beres. Worth it banget buat yang butuh bantuan cepat.”
      </p>
      <p style={styles.testimonialAuthor}>— Fajar, Informatika</p>
    </div>
    <div style={styles.testimonialCard}>
      <p style={styles.testimonialText}>
        “Udah dua kali pake jasa ini buat laporan akhir. Selalu profesional dan rapi. Thanks GaspollJokk!”
      </p>
...
const styles = {
  ...
  navbar: {
    ...
    top: 0,
    zIndex: 10,
    boxShadow: '0 4px 12px rgba(255, 254, 254, 0.2)',
  },
  logo: {
    fontSize: '1.6rem',
    fontWeight: 'bold',
